...
public class ManageProduct extends javax.swing.JFrame {
    ...
    //variable tipo int para guardar la primary key
    ...
    private void getAllCategory() {
        //conectar con la base de datos para obtener los datos de categoría
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            //result set guarda los datos obtenidos de la base de datos
            ResultSet rs = st.executeQuery("select * from category");
            comboBoxCategory.removeAllItems();

            //agregar dinámicamente lso nuevos items a la combobox
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 91, 450, 477));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, 336, -1));

        lblQuantity.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblQuantity.setText("Quantity");
        getContentPane().add(lblQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 200, -1, -1));
        ...
        getContentPane().add(txtQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 336, -1));
        ...
        getContentPane().add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 290, 336, -1));
        ...
        getContentPane().add(txtDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 370, 336, -1));
        ...
        getContentPane().add(comboBoxCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 450, 336, -1));
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 500, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 500, 80, -1));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 500, 80, -1));
